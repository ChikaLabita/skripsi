...
<head>
    ...
    <title>Test 16PF by Cattell</title>
    <!-- Favicon-->
    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">Test 16PF</span></a>
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">16PF Questionnaire Form : C &middot; By Raymond B. Cattell
                                    &middot; 1980 </div>
                            </div>
                            <div class="fs-3 fw-light text-muted">Hello, welcome to</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Test 16
                                    Personality Factor Questionnaire</span></h1>
                            <div
                                ...
                                <a class="btn btn-secondary btn-lg px-5 py-3 fs-6 fw-bolder"
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-center">
                <div class="col-auto">
                    <div class="small m-0">Copyright &copy; Test 16 PF 2023</div>
                </div>
            </div>
        </div>
    </footer>
